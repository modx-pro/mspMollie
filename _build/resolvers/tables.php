...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('mspmollie', MODX_CORE_PATH . 'components/mspmollie/model/');
            $modx->addExtensionPackage('mspmollie', '[[++core_path]]components/mspmollie/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/mspmollie/model/schema/mspmollie.mysql.schema.xml';
